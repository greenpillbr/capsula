...
const SUB_TABS = [
  { href: "/gpbrv-swap/minipay/deposit", labelKey: "gpbrvSwap.minipayTabDeposit" },
  { href: "/gpbrv-swap/minipay/configure", labelKey: "gpbrvSwap.minipayTabConfigure" },
] as const;
