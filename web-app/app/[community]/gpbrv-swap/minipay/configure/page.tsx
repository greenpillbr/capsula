...
import { ConfigureFromMinipay } from "@/app/[community]/gpbrv-swap/minipay/configure/ConfigureFromMinipay";
...
export default async function GpbrvMinipayConfigurePage({
  ...
  return (
    <div className="space-y-6">
      ...
      <ConfigureFromMinipay swapper={config.contracts.swapper ?? undefined} />
    </div>
  );
}
